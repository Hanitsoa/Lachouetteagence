...
+function(b){function e(a){return this.each(function(){var c=b(this),d=c.data("bs.button"),h="object"==typeof a&&a;d||c.data("bs.button",d=new f(this,h));"toggle"==a?d.toggle():a&&d.setState(a)})}var f=function(a,c){this.$element=b(a);this.options=b.extend({},f.DEFAULTS,c);this.isLoading=!1};f.VERSION="3.3.5";f.DEFAULTS={loadingText:"loading..."};f.prototype.setState=function(a){var c=this.$element,d=c.is("input")?"val":"html",h=c.data();a+="Text";null==h.resetText&&c.data("resetText",c[d]());setTimeout(b.proxy(function(){c[d](null==
...
b.proxy(this.keydown,this));"hover"!=this.options.pause||"ontouchstart"in document.documentElement||this.$element.on("mouseenter.bs.carousel",b.proxy(this.pause,this)).on("mouseleave.bs.carousel",b.proxy(this.cycle,this))};f.VERSION="3.3.5";f.TRANSITION_DURATION=600;f.DEFAULTS={interval:5E3,pause:"hover",wrap:!0,keyboard:!0};f.prototype.keydown=function(a){if(!/input|textarea/i.test(a.target.tagName)){switch(a.which){case 37:this.prev();break;case 39:this.next();break;default:return}a.preventDefault()}};
...
d=new e(this,f));"string"==typeof a&&d[a]()})}e.VERSION="3.3.5";e.DEFAULTS={offset:10};e.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)};e.prototype.refresh=function(){var a=this,c="offset",d=0;this.offsets=[];this.targets=[];this.scrollHeight=this.getScrollHeight();b.isWindow(this.$scrollElement[0])||(c="position",d=this.$scrollElement.scrollTop());this.$body.find(this.selector).map(function(){var a=
...
+function(b){function e(a){return this.each(function(){var c=b(this),d=c.data("bs.tab");d||c.data("bs.tab",d=new f(this));"string"==typeof a&&d[a]()})}var f=function(a){this.element=b(a)};f.VERSION="3.3.5";f.TRANSITION_DURATION=150;f.prototype.show=function(){var a=this.element,d=a.closest("ul:not(.dropdown-menu)"),e=a.data("target");if(e||(e=a.attr("href"),e=e&&e.replace(/.*(?=#[^\s]*$)/,"")),!a.parent("li").hasClass("active")){var f=d.find(".active:last a"),m=b.Event("hide.bs.tab",{relatedTarget:a[0]}),
...
f.VERSION="3.3.5";f.RESET="affix affix-top affix-bottom";f.DEFAULTS={offset:0,target:window};f.prototype.getState=function(a,b,d,e){var c=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=d&&"top"==this.affixed)return d>c?"top":!1;if("bottom"==this.affixed)return null!=d?c+this.unpin<=f.top?!1:"bottom":a-e>=c+g?!1:"bottom";var h=null==this.affixed;f=h?c:f.top;return null!=d&&d>=c?"top":null!=e&&f+(h?g:b)>=a-e?"bottom":!1};f.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;
